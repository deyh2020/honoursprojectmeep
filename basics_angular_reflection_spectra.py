...
def main(args):
    ...
    sources = [
        mp.Source(mp.GaussianSource(fcen, fwidth=df), component=mp.Ex, center=mp.Vector3(0, 0, -0.5 * sz + dpml))]
    ...
    geometry = [mp.Block(mp.Vector3(mp.inf, mp.inf, 0.5 * sz), center=mp.Vector3(0, 0, 0.25 * sz),
    ...
    for i in range(nfreq):
        print("refl:, {}, {}, {}, {}".format(k.x, 1 / freqs[i], math.degrees(math.asin(k.x / freqs[i])),
